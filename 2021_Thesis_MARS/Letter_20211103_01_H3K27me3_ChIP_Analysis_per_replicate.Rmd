...
output:
    html_document:
        toc: TRUE
meta:
    exp_id: 20211103_01_H3K27me3_ChIP_Analysis_per_replicate.Rmd
    type: analyse
    modules:
        - R/4.1
---
...
ggsave("out/H3K27me3_Cp.pdf", plot=graph, width=15, height=10)
...
graph <- 
   ...
   scale_color_brewer(palette="Set1")
ggsave("out/H3K27me3_per_time.pdf", plot=graph, width=15, height=10)
...
graph <- 
   ...
   scale_color_brewer(palette="Set1")
ggsave("out/H3K27me3_per_antibody.pdf", plot=graph, width=15, height=10)
...
graph<- 
   ...
   scale_color_brewer(palette="Set1")
ggsave("out/H3K27me3_enrichment.pdf", plot=graph, width=6, height=8)
...
multcomp::cld(MRN1_emmeans, Letters=letters)
```
...
for (position in unique(H3K27me3_enrichment$Position)){
  ...
  theme(axis.text=element_text(size=11))
    ggsave(str_c("out/ChIP_TB/letter_H3K27me3_", position, ".pdf"), plot=graph, width=2, height=3)
}
