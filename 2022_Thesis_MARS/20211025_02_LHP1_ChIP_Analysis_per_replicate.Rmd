...
output:
    html_document:
        toc: TRUE
meta:
    exp_id: 20211025_02_LHP1_ChIP_Analysis_per_replicate.Rmd
    type: analyse
    modules:
        - R/4.1
---
...
ggsave("out/ChIP_TB/LHP1_Cp.pdf", plot=graph, width=15, height=10)
...
graph <- 
   ...
   scale_color_brewer(palette="Set1")
ggsave("out/ChIP_TB/LHP1_per_time.pdf", plot=graph, width=15, height=10)
...
graph <- 
   ...
   scale_color_brewer(palette="Set1")
ggsave("out/ChIP_TB/LHP1_per_antibody.pdf", plot=graph, width=15, height=10)
...
graph<- 
   ...
   scale_color_brewer(palette="Set1")
ggsave("out/ChIP_TB/LHP1_enrichment.pdf", plot=graph, width=6, height=8)
...
for (position in unique(LHP1_enrichment$Position)){
  ...
  theme(axis.text=element_text(size=14))
    ggsave(str_c("out/ChIP_TB/NEWSIZE_LHP1_", position, ".pdf"), plot=graph, width=2, height=3)
}
