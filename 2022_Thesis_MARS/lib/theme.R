...
genotype_metadata_germination <-
  tibble(genotype=c("col", "rnai92", "rnai38", "pro", "35smrn1", "mrn1", "crispr"),
         genotype_name=c("Col-0", "RNAi MARS 1", "RNAi MARS 2", "SALK_133089", "35S:MRN1", "mrn1", "CRISPR MARS"),
         genotype_color=c("#636363", "#023858", "#3690c0","#a6bddb", "#004529", "#238443", "#045a8d")) %>%
  # Transform genotype name as a factor keeping the order
  mutate(genotype_name=factor(genotype_name, levels=genotype_name))
